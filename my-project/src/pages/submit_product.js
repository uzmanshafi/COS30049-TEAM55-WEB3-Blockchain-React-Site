        ...
        <div className=" mx-20 px-20">
            ...
            <div className="grid grid-rows-5 grid-flow-col gap-4 px-20">
                <div className="row-start-1 p-7 row-span-1 col-span-2 bg-primary-color rounded-md text-center col-start-1 col-span-2 flex flex-col">
                    <div className="p-4 py-16 bg-accent-color rounded-md w-full h-1/2 text-2xl"><FontAwesomeIcon icon={faImage} size="2xl" style={{color: "#070708",}} /></div>
                    <br></br>
                ...
                <div class="row-start-1 p-7  row-span-1 bg-primary-color rounded-md col-end-8 col-span-4">
                    <form className="">
                        <div className="flex items-center">
                            <input className="mr-2 rounded-md bg-accent-color placeholder-black text-white" type="text" size="30" maxlength="30" placeholder="ENTER PRODUCT NAME HERE"></input>
                            <p className="font-bold">* MAX 30 CHARACTERS</p>
                        </div>
                        <br></br>
                        <div className="flex items-center">
                            <textarea className="mr-2 h-40 bg-accent-color rounded-md placeholder-top-left placeholder-black text-white w-80" type="text" placeholder="ENTER DESCRIPTION HERE" size="30"></textarea>
                        ...
                        <br></br>
                        <div className="flex items-center">
                            <select id="blockchain" name="blockchain" className="bg-accent-color text-white rounded-md placeholder-white">
                                <option value="" className='text-white'>CHOOSE BLOCKCHAIN</option>
                        ...
                        <br></br>
                        <div className="flex items-center">
                            <input className="mr-2 rounded-md bg-accent-color placeholder-black" type="number" size="100" maxlength="30" placeholder="SUPPLY QUANTITY"></input>
